...
def api_tes():
    import requests
    import json
    url = "https://test.zzcrowd.com/api/v2/publisher-groups"
    ...
    headers = {
        ...
        "Cookie": "session=.eJxFzsEKgkAQANBfiTl7cFe6CB4KlzCYDUEcxot"
                  "QKu6aBatSKv574KUfeLwVysbVQwvh6Kbag9JUEK5wuEMIKFWgL_"
                  "xhm8xFfO50jAETS6bUR9IGs7xnUt-CVASbB4_BNeX47urXn7BV"
                  "y9nT6KWyuk98TSh44Rnl1SCxYKkkUiqYCsMyt7c4OepTtHPTULu9Aw"
                  "K2H5wLNN4.DK0JyQ.ZIdgK4WPwKQ6rHUUk8ew7LWGGfI"
